    ...
    class ci extends W {
        constructor(t, e) {
            super(t, e),
                ...
                (this._menu =
                    z.next(this._element, ti)[0] || z.prev(this._element, ti)[0] || z.findOne(ti, this._parent)),
        ...
        _setListeners() {
            ...
            for (const e of t)
                if ('click' === e)
                    ...
                    const t =
                            e === nn ? this.constructor.eventName('mouseenter') : this.constructor.eventName('focusin'),
                        i =
                            e === nn
